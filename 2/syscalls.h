...
asmlinkage long sys_plus_revert(char __user *usr_input, char __user *user_output);
asmlinkage long sys_minus_revert(char __user *usr_input, char __user *user_output);
