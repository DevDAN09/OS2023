...
asmlinkage long sys_minus_revert(char __user *user_input, char __user *user_output)
{
    char buffer[100];
...
SYSCALL_DEFINE2(minus_revert, char __user *,user_input, char __user *,user_output){
    return sys_minus_revert(user_input, user_output);
}
